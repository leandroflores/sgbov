...
import controlador.visao.painel.novo.financeiro.ControllerPanelNovoReceita;
...
/**
 * <p>Classe de Visao <b>PanelNovoReceita</b>.</p> 
 * <p>Classe responsavel por definir o Painel Grafico da <b>ViewNovoReceita</b> do SGBov.</p>
 * @author Leandro
 * @since  28/12/2020
 * @see    controlador.visao.painel.novo.financeiro.ControllerPanelNovoReceita
 * @see    modelo.entidade.financeiro.Movimentacao
 * @see    visao.painel.novo.PanelNovo
 */
public final class PanelNovoReceita extends PanelNovo {
    
    /**
     * Metodo construtor padrao da Classe.
     * @param view View Novo.
     */
    public PanelNovoReceita(ViewNovo view) {
        super(view);
        controller = new ControllerPanelNovoReceita(this);
        setProperties();
        addComponents();
    }
    ...
    protected void addComponents() {
        ...
        add(createTextFieldNoEditable("tipo", "RECEITA", 30));
    ...
    @Override
    public void clear() {
        getComboBoxTipo().setText("RECEITA");
