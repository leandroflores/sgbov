...
import controlador.visao.painel.editar.financeiro.ControllerPanelEditarReceita;
...
/**
 * <p>Classe de Visao <b>PanelEditarReceita</b>.</p> 
 * <p>Classe responsavel por definir o Painel Grafico da <b>ViewEditarReceita</b> do SGBov.</p>
 * @author Leandro
 * @since  28/12/2020
 * @see    controlador.visao.painel.editar.financeiro.ControllerPanelEditarReceita
 * @see    modelo.entidade.financeiro.Movimentacao
 * @see    visao.painel.editar.PanelEditar
 */
public final class PanelEditarReceita extends PanelEditar {
     ...
     */
    public PanelEditarReceita(ViewEditar view, Movimentacao movimentacao_) {
        super(view);
        movimentacao = movimentacao_;
        controller   = new ControllerPanelEditarReceita(this);
        setProperties();
        addComponents();
        setValues();
